...
export const getUserProducts = async () => {
    return (await $external_api.get("/user/products", {params: { employeeNumber: 1234, key: "0aa96d80" }})).data
}

export const getProductSlides = async (productId: string): Promise<externalProductSlide[]> => {
    return (await $external_api.get("/product/slides",  { params: { productId, employeeNumber: 1234, key: "0aa96d80" }})).data
}
